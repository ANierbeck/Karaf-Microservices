 ...
 *
 */
@Component(configurationPid="de.nierbeck.javaland.calculator", 
...
public class CreditCalculatorImpl implements CreditCalculator {
	...
	/* (non-Javadoc)
	 * @see de.nierbeck.javaland.impl.calc.CreditCalculator#calculateRate(de.nierbeck.javaland.impl.calc.values.Credit)
	 */
	@Override
	...
	@Reference(policy=ReferencePolicy.DYNAMIC, unbind="unbindResolver")
	public void bindResolver(MavenResolver resolver) {
		this.resolver = resolver;
	}
	
	public void unbindResolver(MavenResolver resolver) {
		this.resolver = null;
	}
